      ...
      <div class="row ml-7">
        <div class="col-xl-10 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form action="{{ url('/admin/client/'.$client->id.'/edit') }} " method="post">
              	@csrf
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="category" name="name_cli" class="form-control form-control-alternative" placeholder="Nombre de categoria..." value="{{ old('name_cli',$client->name_cli) }}">
                      </div>
                    </div>
                  </div>
                  <div class="row">
